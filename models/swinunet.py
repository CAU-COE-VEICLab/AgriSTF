...
class WindowAttention(nn.Module):
    ...
    def __init__(self, use_relat_position, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, use_relat_position, dim, input_resolution, num_heads, window_size=7, shift_size=0,
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, use_shifted_window, use_relat_position, dim, input_resolution, depth, num_heads, window_size,
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, use_shifted_window=True, use_relat_position=True, 
